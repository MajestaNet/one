...
| Public docs (vendor, external) | — (not this repo) | `one.majesta.net` is a separate CMS aggregator; GitHub `docs/` stay here | [agent-public-docs.md](./agent-public-docs.md) · [public-docs-site.md](./public-docs-site.md) | [BP-067](../../backlog/BP-067-public-docs-site.md); do not add `tools/one-docs` |
...
| Managed package automations | `internal/packages`, `internal/seed`, `internal/metadata`, `internal/httpapi`, `internal/dataengine`, `internal/deploy`, `migrations/` | `AutomationDef` on modules; SyncAutomationManaged; PATCH `active` on managed; `description`; dispatch pack gate | [package-automations-build-plan.md](./package-automations-build-plan.md) | ADR-033, BP-069, ADR-014, ADR-029 |
...
| Control IDE (vendor, optional client) | `tools/control-ide` | `src/main/`, `src/preload/`, `src/renderer/` (`App.tsx`, `theme.ts`, `workspace/`, `run/`, `run/graph/`, `api.ts`, panels), `package.json` | [agent-control-ide.md](./agent-control-ide.md) | ADR-012, ADR-030; lockstep OK for [BP-065](../../backlog/BP-065-ide-backend-coupling.md); paint [BP-068](../../backlog/BP-068-ide-brand-visual.md) mitigated |
...
6. GitHub docs edits stay in operator-facing `docs/` ([agent-public-docs.md](./agent-public-docs.md)); do not add a publisher, Netlify, or CMS dependency. They do not edit Go handlers or Control IDE.
