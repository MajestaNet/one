...
| [ide-brand-visual-build-plan.md](./ide-brand-visual-build-plan.md) | **Shipped:** Control IDE navy/gold restyle + sourced logo (top-left globe; white light theme, not ivory) — [BP-068](../../backlog/BP-068-ide-brand-visual.md) mitigated |
