...
BP-066 may change existing panels so they call shipped family routes honestly. That is **not** a license to reopen the frozen list.
...
**Finish — optional IDE demo client:** [BP-066](./BP-066-ide-demo-client-fidelity.md)
