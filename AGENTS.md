...
| Control IDE (Electron / React / Vitest) — optional client; **lockstep refactor OK** when it cleans the install ([BP-065](backlog/BP-065-ide-backend-coupling.md)); demo-client honesty ([BP-066](backlog/BP-066-ide-demo-client-fidelity.md)); brand restyle ([BP-068](backlog/BP-068-ide-brand-visual.md)); no new Electron-only product chrome | [agent-control-ide.md](docs/architecture/agent-control-ide.md) · [ide-demo-client-uplift-build-plan.md](docs/architecture/ide-demo-client-uplift-build-plan.md) · [ide-brand-visual-build-plan.md](docs/architecture/ide-brand-visual-build-plan.md) | `control-ide` |
